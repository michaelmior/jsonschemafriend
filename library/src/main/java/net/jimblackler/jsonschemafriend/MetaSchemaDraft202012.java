  ...
  private static final String[] SCHEMA_JSONS =
      new String[] {
        "{\n"
            ...
            + "  ],\n"
            + "  \"type\": [\"object\", \"boolean\"],\n"
            + "  \"$comment\": \"This meta-schema also defines keywords that have appeared in"
            + " previous drafts in order to prevent incompatible extensions as they remain in"
            + " common use.\",\n"
            + "  \"properties\": {\n"
            + "    \"definitions\": {\n"
            ...
            + " \\\"dependentSchemas\\\" and \\\"dependentRequired\\\" in order to serve their"
            + " differing semantics.\",\n"
            + "      \"type\": \"object\",\n"
            + "      \"additionalProperties\": {\n"
            + "        \"anyOf\": [{\"$dynamicRef\": \"#meta\"}, {\"$ref\":"
            ...
            + "    },\n"
            + "    \"$recursiveAnchor\": {\n"
            + "      \"$comment\": \"\\\"$recursiveAnchor\\\" has been replaced by"
            + " \\\"$dynamicAnchor\\\".\",\n"
            + "      \"$ref\": \"meta/core#/$defs/anchorString\",\n"
            + "      \"deprecated\": true\n"
            + "    },\n"
            + "    \"$recursiveRef\": {\n"
            + "      \"$comment\": \"\\\"$recursiveRef\\\" has been replaced by"
            + " \\\"$dynamicRef\\\".\",\n"
